					...
					<div class="art-header-inner">
						...
						<div class="art-logo">
							<h1 class="art-logo-name">
								<a href="./charts.jsp">Charts Manager</a>
							</h1>
						</div>
					</div>
				</div>
				...
				<div class="art-nav-wrapper">
					<div class="art-nav-inner">
						<div class="art-nav-center">
							<ul class="art-hmenu">
								<li><a href="./charts.jsp" class="active">Charts</a></li>
														...
														<div class="art-layout-cell layout-item-2"
															...
															<%
																...
																if ((contentType != null)
																	...
																	ChartModel c = DB_Process.fromCSV(name, description, fichero);
											...
											<table id="rounded-corner"
												...
												<tfoot>
													...
													<tr>
														...
														<td colspan="4" class="rounded-foot-left"><em>Charts
																data obtained from the Database. The manager is able to
																Modify or Delete charts.</em></td>
												...
												<tbody>
													...
													<tr>
														...
														<td><%=chart.getType()%></td>
														<td><a
															href="<%=request.getServletPath().replace("/", "") + "?edit="
						+ chart.getId()%>" /><img
															src="images/edit.png" alt="Edit Chart" /></a> <a
															href="<%=request.getServletPath().replace("/", "")
						+ "?delete=" + chart.getId()%>" /><img
